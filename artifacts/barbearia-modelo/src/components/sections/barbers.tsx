          ...
          {barbers.map((barber, index) => (
            ...
            >
              ...
              <div className="text-center">
                ...
                <Button variant="outline" asChild className="w-full font-bold uppercase tracking-wider border-primary text-primary hover:bg-primary hover:text-primary-foreground">

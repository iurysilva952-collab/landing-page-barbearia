    ...
    <section id="inicio" className="relative min-h-[100dvh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-10 relative z-10 pt-24 pb-16">
        <div className="max-w-2xl">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif font-bold text-foreground leading-[1.15] mb-5">
              Corte na régua,{" "}
              <span className="text-primary italic block">barba bem feita</span>
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-muted-foreground mb-10 max-w-lg font-light leading-relaxed"
          >
            A experiência de um grooming atelier premium. Agende pelo WhatsApp
            e seja atendido no seu horário — sem filas, sem espera.
          </motion.p>
          ...
          >
            ...
            <Button
              ...
              variant="outline"
              asChild
              className="text-sm font-bold uppercase tracking-widest h-13 px-8 bg-transparent border-foreground/20 text-foreground hover:border-primary hover:text-primary transition-colors"
          ...
          >
            {[
              ...
              <div key={stat.label}>
                ...
                <p className="text-xs text-muted-foreground uppercase tracking-normal mt-0.5">{stat.label}</p>
              </div>
            ))}
          </motion.div>
        </div>
